...
const SearchBar = (props) => {
  ...
  const [label, setLabel] = useState('Search form a movie or a tv show ...');
  const [result, setResult] = useState(null)

  const API = (query) => {
    return (
      'https://api.themoviedb.org/3/search/movie?api_key=0ec464bc3151bee6274e541b3030fa57&query='+query+'&language=en-US&page=1&include_adult=true'
    );
  }
