...
async function clickUntilOk(driver,selector,n,text){
    ...
    let url = await driver.findElement(By.css(selector)).click().then(async () => {

        console.log("REQUEST OK !");
        await driver.wait(until.elementLocated(By.xpath("//iframe[@style='width: 100%; height: 100%;']")), timeout);
        console.log("ok 2");
        await driver.switchTo().frame(driver.findElement(By.xpath("//iframe[@style='width: 100%; height: 100%;']")));
...
function findUrl(x,url,driver, callback) {
  run(x,url,driver).then(callback).catch(console.error);
}


// async function run(driver, maxTries) {
//   run_aux(driver, maxTries);
// }

// async function run_aux(driver, maxTries) {
//   console.log(driver);

//   try {
//     console.log('Run');

//     await driver.get('https://fmovies.to/film/midsommar.lr3oq');
//     console.log('ok site');
//     await driver.wait(until.elementLocated(By.className('episodes')), timeout);
//     console.log('ok server');
//     let res1 = await driver.findElement(By.className('episodes'));
//     console.log(res1);

//     await driver.wait(until.elementLocated(By.xpath('//*[@id="player"]/iframe')), timeout);
//     console.log('ok 2');
//     await driver.switchTo().frame(driver.findElement(By.xpath('//*[@id="player"]/iframe')));
//     console.log('ok 3');
//     await driver.wait(until.elementLocated(By.id('videolink')), timeout);
//     console.log('ok 4');
//     let res = await driver.findElement(By.id('videolink'));
//     console.log(await res.getAttribute('innerText'));
//     // driver.quit();
//     return res;
//   } catch (err) {
...
//       throw err;
//     }
//     return run_aux(driver, maxTries - 1);
//   }
